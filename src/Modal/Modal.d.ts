...
export declare type StyleFn = (provided: React.CSSProperties) => React.CSSProperties;
export declare type StylesKeys = 'overlay' | 'constraints' | 'contentOuter' | 'contentInner' | 'closeButton';
...
export declare type MotionProps = {
    animate?: string | AnimationControls | TargetAndTransition | string[] | undefined;
    initial?: any;
};
...
export declare type DragConstraintsType = false | {
